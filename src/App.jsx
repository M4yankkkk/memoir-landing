...
export default function App() {
  ...
  return (
    <div ref={containerRef}>
      ...
      {/* REST OF PAGE */}
      <div id="page" ref={pageRef} className="opacity-100 transition-opacity duration-300">
        <section id="hero" className="min-h-screen pt-32 px-6 md:px-12 lg:px-16 xl:px-24 pb-20 flex items-start relative overflow-hidden perspective-[1000px]">
          ...
          <div className="absolute right-0 md:right-6 lg:right-12 xl:right-16 top-[60px] w-[55%] max-w-[680px] h-[calc(100vh-60px)] flex items-center opacity-0 transition-opacity duration-[10ms] transform-style-3d [&.show]:opacity-100" id="hero-svg-slot" ref={heroSvgSlotRef}>
        ...
        <footer className="text-center py-10 text-xs text-[#aaa] border-t border-[var(--gray-mid)]"><p>© 2024 Memoir Inc. All rights reserved.</p></footer>
      </div>
    </div>
  );
}
